...
@=%token <int_value>     WITH_TOP_OFFSET@>@/
...
@=%token <real_value>    ABSOLUTE_MAGNITUDE@>@/
@=%token <real_value>    APPARENT_MAGNITUDE_VARIES@>@/ 
@=%token <real_value>    ABSOLUTE_MAGNITUDE_VARIES@>@/
...
@=%token <int_value>     NO_NEWLINE@>@/
@=%token <int_value>     IS_OPEN@>@/
@=%token <int_value>     REOPEN@>@/
...
@=%left <int_value> LENGTH ARC_LENGTH MAGNITUDE SIZE SQRT @>@/
@=SIND COSD TAND ARCSIND ARCCOSD ARCTAND @>@/
@=MLOG MEXP MODULUS@>@/
@=UNIFORMDEVIATE FLOOR WPART XPART YPART ZPART CEILING ROUND@>@/
@=MAX MIN@>@/
...
@=%token <int_value> UPCASE@>@/
@=%token <int_value> DOWNCASE@>@/
...
LDF 2022.04.19.
Added token declarations for |TEST_PLANAR|, |MAKE_PLANAR|, |NO_TEST_PLANAR| 
and |NO_MAKE_PLANAR|.
\ENDLOG
...
@=%token <int_value> NO_TEST_PLANAR@>@/
@=%token <int_value> NO_MAKE_PLANAR@>@/
...
Scan_Parse
{
  ...
  extern const unsigned int STARS_BAYER_DESIGNATION_GREEK_LETTER_TEX  =        128U;                                               
  extern const unsigned int STARS_BS_HR_NUMBER                        =        256U;  /* $2^8$  */      
  extern const unsigned int STARS_BS_NUMBER                           =        512U;                     
  extern const unsigned int STARS_HR_NUMBER                           =       1024U;                    
  extern const unsigned int STARS_APPROX_RANK_APPARENT_MAGNITUDE      =       2048U;                    
  extern const unsigned int STARS_APPARENT_MAGNITUDE                  =       4096U;  /* $2^12$ */          
  extern const unsigned int STARS_CONSTELLATION_ABBREVIATION          =       8192U;                    
  extern const unsigned int STARS_CONSTELLATION_FULL_NAME             =      16384U;                    
  extern const unsigned int STARS_CONSTELLATION_NAME_GENITIVE         =      32768U;                    
  extern const unsigned int STARS_CONSTELLATION_NUMBER                =      65536U;  /* $2^16$ */      
  extern const unsigned int STARS_RIGHT_ASCENSION_HOURS               =     131072U;                    
  extern const unsigned int STARS_RIGHT_ASCENSION_MINUTES             =     262144U;                    
  extern const unsigned int STARS_RIGHT_ASCENSION_SECONDS             =     524288U;                    
  extern const unsigned int STARS_RIGHT_ASCENSION_DECIMAL_HOURS       =    1048576U;  /* $2^20$ */      
  extern const unsigned int STARS_RIGHT_ASCENSION_DECIMAL_DEGREES     =    2097152U;                    
  extern const unsigned int STARS_DECLINATION_DEGREES                 =    4194304U;                    
  extern const unsigned int STARS_DECLINATION_MINUTES                 =    8388608U;                    
  extern const unsigned int STARS_DECLINATION_SECONDS                 =   16777216U;  /* $2^24$ */      
  extern const unsigned int STARS_DECLINATION_DECIMAL_DEGREES         =   33554432U;                    
  extern const unsigned int STARS_RIGHT_ASCENSION                     =   67108864U;                    
  extern const unsigned int STARS_DECLINATION                         =  134217728U;                    
  extern const unsigned int STARS_IS_BINARY                           =  268435456U;  /* (expt 2 28)  */
  extern const unsigned int STARS_ABSOLUTE_MAGNITUDE                  =  536870912U;                    
  extern const unsigned int STARS_APPARENT_MAGNITUDE_VARIES           = 1073741824U;  
  extern const unsigned int STARS_ABSOLUTE_MAGNITUDE_VARIES           = 2147483648U;  /* (expt 2 31)  */
};
...
Scan_Parse
{
  ...
  extern const unsigned int STARS_STAR_CONSTANT_NAME;   
  extern const unsigned int STARS_COMMON_NAME;   
  extern const unsigned int STARS_GREEK_NAME;                  
  extern const unsigned int STARS_LATIN_NAME;                 
  extern const unsigned int STARS_ARABIC_NAME;                 
  ...
  extern const unsigned int STARS_BAYER_DESIGNATION_GREEK_LETTER_TEX; 
  ...
  extern const unsigned int STARS_APPARENT_MAGNITUDE_VARIES; 
  extern const unsigned int STARS_ABSOLUTE_MAGNITUDE_VARIES;
  ...
  extern const unsigned int STARS_RIGHT_ASCENSION_HOURS;
...
@*1 {\bf name\_map}, {\bf type\_name\_map} {\bf star\_field\_name\_map}. @>
\initials{LDF Undated.}
...
Added declaration of |star_field_name_map|.
\ENDLOG 
