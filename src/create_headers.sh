...
make arc.h++ circles.h++ cncsctlt.h++ cnepspng.h++ colors.h++ \
     complex.h++ cones.h++ conicsct.h++ conveps.h++ crclslc.h++ \
     creatnew.h++ cuboid.h++ curves.h++ cylinder.h++ dashptrn.h++ \
     ...
     mpoutput.h++ newwrite.h++ nurbs.h++ origami.h++ parabola.h++ parabold.h++ paraellp.h++ \
