...
\advance\baselineskip by 2pt
\obeylines
\setbox0=\hbox to 0pt{\vtop{\A Andromeda
\A Antlia
\A Apus
\A Aquarius
\A Aquila
...
\setbox1=\hbox to 0pt{\vtop{\A Cetus
\A Chamaeleon
\A Circinus
\A Columba
\A Coma Berenices
...
\setbox2=\hbox to 0pt{\vtop{\A Horologium
\A Hydra
\A Hydrus
\A Indus
\A Lacerta
...
\setbox3=\hbox to 0pt{\vtop{\A Pavo
\A Pegasus
\A Perseus
\A Phoenix
\A Pictor
...
\setbox4=\hbox to 0pt{\vtop{\A Triangulum
...
\vskip1.5\baselineskip
\line{\hskip.25\hsize {\largebx Constellations}\hss}
\vskip1.5\baselineskip
\line{\box0\hskip.125\hsize\box1\hskip.125\hsize\box2\hskip.125\hsize\box3\hskip.125\hsize\box4}
