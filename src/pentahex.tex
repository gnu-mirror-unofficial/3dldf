%% pentahex.tex
%% Created by Laurence D. Finston (LDF) Wed 22 Sep 2021 01:07:14 AM CEST
...
\centerline{{\largebx Pentagonal Hexecontahedron}}
\vskip\baselineskip
...
\leavevmode\box0 October 10, 2021 %% Last updated
...
\Chapter{dextro}{Plans --- Dextro (Right-Handed)}
\hldest{xyz}{}{dextro}
\centerline{{\largebx Pentagonal Hexecontahedron --- Dextro (Right-Handed)}}
\vskip\baselineskip
\Section{dextro left}{Left Half}
\hldest{xyz}{}{dextro left}
\centerline{{\largebx Left Half}}\vss}
%
\vbox to 0pt{\vskip.75\vsize\vskip-.5cm\line{\hskip.75\hsize\hskip1cm\epsffile{pentahex.5}\hss}\vss}
%
\vbox to 0pt{\vskip-1cm
\line{\hskip1cm\epsffile{pentahex.1}\hss}\vss}
\vfil\eject

%% *** (3)

\vbox to 0pt{\vskip-1.5cm
\Section{dextro right}{Right Half}
\hldest{xyz}{}{dextro right}
\centerline{{\largebx Pentagonal Hexecontahedron --- Dextro (Right-Handed)}}\vss}
\vskip-2\baselineskip
\centerline{{\largebx Right Half}}
\vskip2\baselineskip
\vbox to 0pt{\vskip-2\baselineskip
\centerline{\epsffile{pentahex.2}}\vss}
\vfil\eject

%% *** (3)

\vbox to 0pt{\vskip-1.5cm
\Section{dextro left numbered}{Left Half With Numbered Pentagons}
\hldest{xyz}{}{dextro left numbered}
\centerline{{\largebx Pentagonal Hexecontahedron --- Dextro (Right-Handed)}}\vss}
\vskip-2\baselineskip
\centerline{{\largebx Left Half With Numbered Pentagons}}
\vskip2\baselineskip
\vbox to 0pt{\vskip-2\baselineskip
\centerline{\epsffile{pentahex.6}}\vss}
\vfil\eject

%% *** (3)

\vbox to 0pt{\vskip-1.5cm
\Section{dextro right numbered}{Right Half With Numbered Pentagons}
\hldest{xyz}{}{dextro right numbered}
\centerline{{\largebx Pentagonal Hexecontahedron --- Dextro (Right-Handed)}}\vss}
\vskip-2\baselineskip
\centerline{{\largebx Right Half With Numbered Pentagons}}
\vskip2\baselineskip
\vbox to 0pt{\vskip-2\baselineskip
\centerline{\epsffile{pentahex.7}}\vss}
\vfil\eject

%% *** (3)

\vbox to 0pt{\vskip-1.5cm
\Chapter{laevo}{Plans --- Laevo (Left-Handed)}
\hldest{xyz}{}{laevo}
\centerline{{\largebx Pentagonal Hexecontahedron --- Laevo (Left-Handed)}}
\vskip\baselineskip
\Section{laevo left}{Left Half}
\hldest{xyz}{}{laevo left}
\centerline{{\largebx Left Half}}\vss}
%
\vbox to 0pt{\vskip.75\vsize\vskip-.5cm\line{\hskip.75\hsize\hskip1cm\epsffile{pentahex.5}\hss}\vss}
%
\vbox to 0pt{\vskip-.5cm
\centerline{\epsffile{pentahex.3}}\vss}
\vfil\eject

%% *** (3)

\vbox to 0pt{\vskip-1.5cm
\Section{laevo right}{Right Half}
\hldest{xyz}{}{laevo right}
\centerline{{\largebx Pentagonal Hexecontahedron --- Laevo (Left-Handed)}}\vss}
\vskip-2\baselineskip
\centerline{{\largebx Right Half}}
\vskip2\baselineskip
\vbox to 0pt{\vskip-.5cm
\centerline{\epsffile{pentahex.4}}\vss}
\vfil\eject
...
\vbox to 0pt{\vskip-1.5cm
\Section{laevo left numbered}{Left Half With Numbered Pentagons}
\hldest{xyz}{}{laevo left numbered}
\centerline{{\largebx Pentagonal Hexecontahedron --- Laevo (Left-Handed)}}\vss}
\vskip-2\baselineskip
\centerline{{\largebx Left Half With Numbered Pentagons}}
\vskip2\baselineskip
\vbox to 0pt{\vskip-2\baselineskip
\centerline{\epsffile{pentahex.8}}\vss}
\vfil\eject

%% *** (3)

\vbox to 0pt{\vskip-1.5cm
\Section{laevo right numbered}{Right Half With Numbered Pentagons}
\hldest{xyz}{}{laevo right numbered}
\centerline{{\largebx Pentagonal Hexecontahedron --- Laevo (Left-Handed)}}\vss}
\vskip-2\baselineskip
\centerline{{\largebx Right Half With Numbered Pentagons}}
\vskip2\baselineskip
\vbox to 0pt{\vskip-2\baselineskip
\centerline{\epsffile{pentahex.9}}\vss}
\vfil\eject

%% * (1) Separate Tabs

\vbox to 0pt{\vskip-1.5cm
\Chapter{separate tabs}{Separate Tabs}
\hldest{xyz}{}{separate tabs}
\centerline{{\largebx Separate Tabs}}\vss}
%
\vbox to 0pt{\vskip-1cm\line{\hskip-.5cm\epsffile{pentahex.14}\hss}\vss}
\vfil\eject

%% * (1)

\vbox to 0pt{\vskip-1.5cm
\Chapter{pentagons}{Pentagons for Cutting Out}
\hldest{xyz}{}{pentagons}
\Section{pentagons not numbered}{Not Numbered}
\hldest{xyz}{}{pentagons not numbered}
\centerline{{\largebx Pentagons for Cutting Out --- Not Numbered}}\vss}
%
\vbox to 0pt{\vskip0cm\line{\hskip-1cm\epsffile{pentahex.10}\hss}\vss}
\vfil\eject
\vbox to 0pt{\vskip0cm\line{\hskip-1cm\epsffile{pentahex.11}\hss}\vss}
\vfil\eject

%% * (1)

\vbox to 0pt{\vskip-1.5cm
\Section{pentagons numbered}{Numbered}
\hldest{xyz}{}{pentagons numbered}
\centerline{{\largebx Pentagons for Cutting Out --- Numbered}}\vss}
%
\vbox to 0pt{\vskip0cm
\line{\hskip-1cm\epsffile{pentahex.12}\hss}
\vss}
\vfil\eject
\vbox to 0pt{\vskip0cm
\line{\hskip-1cm\epsffile{pentahex.13}\hss}
\vss}
\vfil\eject
