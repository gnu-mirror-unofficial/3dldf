...
\leavevmode\hbox to \wd0{Created:\hfil}September 22, 2021

\leavevmode\box0 September 22, 2021
...
\vbox to 0pt{\vskip-1.5cm
\Section{dextro left numbered }{Left Half With Numbered Polygons}
\hldest{xyz}{}{dextro left numbered}
\centerline{{\largebx Pentagonal Hexecontahedron --- Dextro (Right-Handed)}}\vss}
\vskip-2\baselineskip
\centerline{{\largebx Left Half With Numbered Polygons}}
\vskip2\baselineskip
\vbox to 0pt{\vskip-2\baselineskip
...
\vbox to 0pt{\vskip-1.5cm
\Section{dextro right numbered }{Right Half With Numbered Polygons}
\hldest{xyz}{}{dextro right numbered}
\centerline{{\largebx Pentagonal Hexecontahedron --- Dextro (Right-Handed)}}\vss}
\vskip-2\baselineskip
\centerline{{\largebx Right Half With Numbered Polygons}}
\vskip2\baselineskip
\vbox to 0pt{\vskip-2\baselineskip
