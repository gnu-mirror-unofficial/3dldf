...
\leavevmode\box0 October 3, 2021 %% Updated
...
\centerline{{\largebx Separate Tabs}}
\vbox to 0pt{\vskip1cm\hbox to 0pt{\line{\hskip1.5cm\epsffile{small_rhombi.6}}\hss}\vss}%
\vfil\eject
\endgroup
