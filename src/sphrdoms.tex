...
\Section{Diameter 12cm, 8 Sections}{Diameter 12cm, 8 Sections}
\hldest{xyz}{}{Diameter 12cm, 8 Sections}
\centerline{{\largebx Diameter 12cm, 8 Sections}}\vskip3\baselineskip
\vbox to 0pt{\vskip1cm\centerline{\hskip-2cm\epsffile{sphrdoms.0}\hskip1cm\epsffile{sphrdoms.0}}\vss}
\vfil\eject

%% ***** (5) Page 3

\centerline{\hskip-2cm\epsffile{sphrdoms.0}\hskip1cm\epsffile{sphrdoms.0}}
\vfil\eject
