...
\vbox to 0pt{\vskip1cm\centerline{\hskip-2cm\epsffile{sphrdoms.0}\hskip1cm\epsffile{sphrdoms.0}}\vss}
\vfil\eject
...
\centerline{{\largebx Diameter 20cm, 8 Sections, 45}}\vskip3\baselineskip
\vbox to 0pt{\vskip1cm\centerline{\hskip-2cm\epsffile{sphrdoms.1}\hskip1cm\epsffile{sphrdoms.1}}\vss}
\vfil\eject
