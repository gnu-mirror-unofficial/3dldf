...
\Chapter{plans}{Plans}
\hldest{xyz}{}{plans}
\Section{plans small with gray}{Small--With Gray}
\hldest{xyz}{}{plans small with gray}
\centerline{{\largebx Disdyakis Triacontahedron --- Small --- With Gray}}\vss}
\vskip\baselineskip
\vbox to 0pt{\vskip0pt\line{\hskip0pt\epsffile{disdyakis.1}\hss}\vss}
\vbox to 0pt{\vskip.6667\vsize\line{\hskip0pt\epsffile{disdyakis.200}\hss}\vss}
\vfil\eject
...
\vbox to 0pt{\vskip-1.5cm
\Section{plans small no gray}{Small--No Gray}
\hldest{xyz}{}{plans small no gray}
\centerline{{\largebx Disdyakis Triacontahedron --- Small --- No Gray}}\vss}
\vskip\baselineskip
...
\vbox to 0pt{\vskip-1.5cm
\Section{plans large}{Large}
\hldest{xyz}{}{plans large}
\centerline{{\largebx Disdyakis Triacontahedron --- Large}}\vss}
\vskip-1cm
\vbox to 0pt{\vskip0pt\line{\hskip0pt\epsffile{disdyakis.10}\hss}\vss}
\vbox to 0pt{\vskip0cm\line{\hskip0pt\epsffile{disdyakis.201}\hss}\vss}
\vfil\eject


%% **** (4) Large 2

\vbox to 0pt{\vskip0pt\line{\hskip0pt\epsffile{disdyakis.11}\hss}\vss}
\vfil\eject
...
\vbox to 0pt{\vskip-1.5cm
\Section{plans huge}{Huge}
\hldest{xyz}{}{plans huge}
\centerline{{\largebx Disdyakis Triacontahedron --- Huge}}\vss}
\vskip-1cm
\vbox to 0pt{\vskip-1cm\line{\hskip-1cm\epsffile{disdyakis.20}}\vss}
\vbox to 0pt{\vskip-1cm\line{\hskip.5\hsize\hskip-.75cm\epsffile{disdyakis.21}\hss}\vss}
\vbox to 0pt{\vskip.5\vsize\vskip.75cm\line{\hskip-.5cm\epsffile{disdyakis.202}\hss}\vss}
\vfil\eject

%% *** (3) Huge 2--3

\vbox to 0pt{\vskip0pt\line{\hskip-.75cm\epsffile{disdyakis.22}\hskip-.5cm\epsffile{disdyakis.23}\hss}\vss}
\vfil\eject

%% *** (3) Tiny

\vbox to 0pt{\vskip-1.5cm
\Section{plans tiny}{Tiny}
\hldest{xyz}{}{plans tiny}
\centerline{{\largebx Disdyakis Triacontahedron --- Tiny}}\vss}
\vskip\baselineskip
\vbox to 0pt{\vskip0pt\line{\hskip0pt\epsffile{disdyakis.50}\hss}\vss}
\vbox to 0pt{\vskip.333\vsize\vskip2cm\line{\hskip0cm\epsffile{disdyakis.203}\hss}\vss}
\vfil\eject
