...
@q ***** (5) string_primary --> CONSTELLATION_FULL_NAME star_expression.@>

@*4 \§string primary> $\longrightarrow$ \.{CONSTELLATION\_FULL\_NAME} \§star expression>.
...
{ 
   ...
   if (DEBUG) 
     {
         cerr_strm << thread_name << "*** Parser:  `string_primary --> "
	           << "CONSTELLATION_FULL_NAME star_expression'.";
...
@ |star != 0 && star->ctr > 0|.  Set |@=$$@>| to |star->constellation_full_name|.
\initials{LDF 2021.09.06.}
...
@<Define rules@>=
   ...
   {
      *s = star->constellation_full_name;
      @=$$@> = static_cast<void*>(s); 
   }
@q ******* (7) @> 
...
@q ***** (5) string_primary --> CONSTELLATION_NAME_GENITIVE star_expression.@>

@*4 \§string primary> $\longrightarrow$ \.{CONSTELLATION\_NAME\_GENITIVE} \§star expression>.
\initials{LDF 2021.09.08.}
...
@<Define rules@>=
@=string_primary: CONSTELLATION_NAME_GENITIVE star_expression@>@/
{ 
   @<Common declarations for rules@>@; 
   ...
   if (DEBUG) 
     {
         cerr_strm << thread_name << "*** Parser:  `string_primary --> "
	           << "CONSTELLATION_NAME_GENITIVE star_expression'.";
...
@ |star != 0 && star->ctr > 0|.  Set |@=$$@>| to |star->constellation_name_genitive|.
\initials{LDF 2021.09.06.}
...
@<Define rules@>=
   ...
   {
      *s = star->constellation_name_genitive;
      @=$$@> = static_cast<void*>(s); 
   }
@q ******* (7) @> 
...
@<Define rules@>=
@=string_primary: BAYER_DESIGNATION_GREEK_LETTER star_expression@>@/
{ 
   @<Common declarations for rules@>@; 
   ...
   if (DEBUG) 
     {
         cerr_strm << thread_name << "*** Parser:  `string_primary --> "
	           << "BAYER_DESIGNATION_GREEK_LETTER star_expression'.";
...
@ |star != 0 && star->ctr > 0|.  Set |@=$$@>| to |star->bayer_designation_greek_letter|.
\initials{LDF 2021.09.08.}
...
@<Define rules@>=
   ...
   {
      *s = star->bayer_designation_greek_letter;
      @=$$@> = static_cast<void*>(s); 
   }
@q ******* (7) @> 
...
@q ***** (5) string_primary --> BAYER_DESIGNATION_GREEK_LETTER_TEX star_expression.@>

@*4 \§string primary> $\longrightarrow$ \.{BAYER\_DESIGNATION\_GREEK\_LETTER\_TEX} \§star expression>.
\initials{LDF 2021.09.08.}
...
@<Define rules@>=
@=string_primary: BAYER_DESIGNATION_GREEK_LETTER_TEX star_expression@>@/
{ 
   @<Common declarations for rules@>@; 
   ...
   if (DEBUG) 
     {
         cerr_strm << thread_name << "*** Parser:  `string_primary --> "
	           << "BAYER_DESIGNATION_GREEK_LETTER_TEX star_expression'.";
...
@ |star != 0 && star->ctr > 0|.  Set |@=$$@>| to |star->bayer_designation_greek_letter_tex|.
\initials{LDF 2021.09.08.}
...
@<Define rules@>=
   ...
   {
      *s = star->bayer_designation_greek_letter_tex;
      @=$$@> = static_cast<void*>(s); 
   }
@q ******* (7) @> 
