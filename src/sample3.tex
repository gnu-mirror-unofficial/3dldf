...
\vskip\baselineskip
\line{\epsffile{sample3.1}\hskip.25cm\epsffile{sample3.2}\hss}
\vskip1cm
\line{\epsffile{sample3.3}\hskip.25cm\epsffile{sample3.4}\hss}
\vfil\eject

%% *** (3) 

\line{\epsffile{sample3.5}\hskip.25cm\epsffile{sample3.6}\hss}
\vfil\eject
