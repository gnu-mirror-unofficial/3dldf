...
\vbox to 0pt{\vbox to 0pt{\vskip-1.5cm\centerline{{\largebx Panels (Isoceles Trapezoids and Triangles)}}\vss}%
\hldest{fit}{}{panels}%
%\vskip2\baselineskip
\line{\hskip2cm\epsffile{clstsph3.0}\hskip13cm\epsffile{clstsph3.1}\hss}%
\vss}
\endgroup
\vfil\eject
