...
\leavevmode\box0 October 11, 2021 %% Last updated
...
\line{\epsffile{clstsph3.0}\hskip1cm\epsffile{clstsph3.1}\hskip1cm\epsffile{clstsph3.2}\hskip1cm
\epsffile{clstsph3.3}\hss}
\vfil\eject
