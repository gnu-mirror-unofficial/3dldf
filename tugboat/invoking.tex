...
Recently, the author has changed this, so that connectors can be specified in the same way as in \MF\/, with
|curl|, |dir|, etc., and particulary with |controls|.  However, at the present time, the only connectors that
have any meaning within 3DLDF itself are |..|, |...|,  |--| and |---| and only in so far, as they indicate
whether a |path| is made up of curves or straight lines or a combination of both.
