...
39,   "lambda",   "Ori",  1879,   5 36 09.5,   +9 56 4);
 0, "v"1046,      "Ori",  1890,   5 36 16.8,   -4 29 00);
...
0,  "",       "",   2666,   7 04 38.0,   -42 21 56);
 0, "v"386,       "Car",  2683,   7 04 39.0,   -56 46 42);
...
48,            "Gem",  2706,   7 13 33.8,   +24 05 46);
 0, "L"_{2},     "Pup",  2748,   7 14 06.2,   -44 40 14);
...
0,  "",       "",   3426,   8 38 17.7,   -43 03 16);
 ...
 0, "v"343,       "Car",  3457,   8 41 01.5,   -59 49 39);
...
0,  "",       "",   3487,   8 46 39.3,   -46 06 35);
 0, "v"344,       "Car",  3498,   8 47 11.2,   -56 50 18);
...
16,   "zeta",     "Hya",  3547,   8 56 22.2,   +5 52 2);
 0, "v"376,       "Car",  3582,   8 57 25.5,   -59 18 04);
...
77,   "xi",       "Cnc",  3627,   9 10 25.2,   +21 58 1);
 0, "v"357,       "Car",  3659,   9 11 27.3,   -59 02 35);
...
0,  "",       "",   4023,  10 15 30.9,   -42 12 51);
 0, "v"337,       "Car",  4050,  10 17 42.2,   -61 25 30);
...
63,   "chi",      "Leo",  4310,  11 05 58.2,   +7 14 0);
 ...
 0, "v"382,       "Car",  4337,  11 09 23.2,   -59 04 32);
...
61,            "UMa",  4496,  11 42 01.2,   +34 05 49);
 ...
 0, "v"810,       "Cen",  4511,  11 44 24.7,   -62 35 32);
...
0,  "",       "",   5139,  13 37 37.8,   +71 08 54);
 ...
 0, "v"744,       "Cen",  5134,  13 41 09.0,   -50 02 35);
...
85,   "eta",      "UMa",  5191,  13 48 16.1,   +49 13 1);
 0, "v"766,       "Cen",  5171,  13 48 29.4,   -62 40 53);
 5,   "upsilon",  "Boo",  5200,  13 50 22.2,   +15 42 2);
 2,  "v"806,      "Cen",  5192,  13 50 31.4,   -34 32 3);
...
0,  "",       "",   5358,  14 21 37.9,   -56 28 14);
 ...
 0, "v"761,       "Cen",  5378,  14 24 11.1,   -39 35 43);
...
65,   "delta",    "Her",  6410,  17 15 47.5,   +24 49 0);
 0, "v"656,       "Her",  6452,  17 21 07.8,   +18 02 21);
...
0,  "",       "",   7589,  19 52 32.5,   +47 04 33);
 0, "v"3961,      "Sgr",  7552,  19 53 05.7,   -39 49 33);
 9,            "Sge",  7574,  19 53 11.3,   +18 43 14);
55,   "eta",      "Aql",  7570,  19 53 24.9,   +1 03 1);
 0, "v"1291,      "Aql",  7575,  19 54 16.8,   -3 03 55);
...
0,  "",       "",   8732,  22 59 36.5,   -35 25 28);
 0, "v"509,       "Cas",  8752,  23 00 52.2,   +57 02 42);
